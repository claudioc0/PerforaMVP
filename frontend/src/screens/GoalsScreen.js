...
const styles = StyleSheet.create({
  ...
  smartButtonText: { color: colors.primary, fontSize: 16, fontWeight: 'bold' },
  sectionTitle: { color: colors.textSecondary, fontSize: 16, fontWeight: '600', marginBottom: 10, borderTopColor: colors.border, borderTopWidth: 1, paddingTop: 20 },
